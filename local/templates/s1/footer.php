                        ...
                        <div class="footer__nav">
                            ...
                            <div class="footer__nav_col">
                                <ul class="footer__nav_about">
                                    ...
                                    <li class="footer__nav_item"> <a href="/novosti/">Новости</a> </li>
...
<?$APPLICATION->IncludeComponent("bitrix:news.list", "contacts_scheme", Array(
    ...
    <script src="https://cdn.jsdelivr.net/npm/typograf@7/dist/typograf.min.js"></script>
    <script src="<?=SITE_TEMPLATE_PATH?>/assets/libs/fancybox/jquery.fancybox.min.js"></script>

    <script src="<?=SITE_TEMPLATE_PATH?>/assets/js/utils.js"></script>
    <script src="<?=SITE_TEMPLATE_PATH?>/assets/js/ui.js"></script>
    <script src="<?=SITE_TEMPLATE_PATH?>/assets/js/map.js"></script>
    <script src="<?=SITE_TEMPLATE_PATH?>/assets/js/swipers.js"></script>
    <script src="<?=SITE_TEMPLATE_PATH?>/assets/js/textHandler.js"></script>
    <script src="<?=SITE_TEMPLATE_PATH?>/assets/js/animations.js"></script>
