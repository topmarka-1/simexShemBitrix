...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	?>
	<section class="section section-dark about section-round-top section-round-bottom anim-fade-in-up" id="<?php echo $this->GetEditAreaId($arItem['ID']);?>">
		<div class="container">
			<div class="heading anim-fade-in-left">
				<h2>Достижения в цифрах</h2>
			</div>
