			...
			<div class="swiper-wrapper">
				<? foreach ($arResult["ITEMS"] as $arItem): ?>
					...
					<div class="swiper-slide">
						<? //printR($arItem);
						?>
						<a href="<?= $arItem['DETAIL_PAGE_URL'] ?>" class="brands__item" data-src="<?= \CFile::GetPath($arItem['PROPERTIES']['LOGO_COLOR']['VALUE']); ?>" data-src-color="<?= \CFile::GetPath($arItem['PROPERTIES']['LOGO_COLOR']['VALUE']); ?>">
							<img src="<?= \CFile::GetPath($arItem['PROPERTIES']['LOGO_COLOR']['VALUE']); ?>" alt="<?= $arItem['NAME'] ?> логотип">
							<h5 class="brands__item_name"><?= $arItem['PROPERTIES']['CARD_TEXT']['VALUE'] ?: $arItem['NAME'] ?></h5>
						</a>
					</div>
				<? endforeach; ?>
			</div>
