...
<section class="section section-white brands anim-fade-in-up">
    <div class="container">
        ...
        <div class="brands__cards">
				<?foreach($arResult["ITEMS"] as $arItem):?>
					...
					?>
						<?//printR($arItem);?>
						<a href="<?=$arItem['DETAIL_PAGE_URL'] ?>" class="brands__item our anim-scale-in" data-src="<?=\CFile::GetPath($arItem['PROPERTIES']['LOGO_GRAY']['VALUE']); ?>" data-src-color="<?=\CFile::GetPath($arItem['PROPERTIES']['LOGO_COLOR']['VALUE']); ?>">
