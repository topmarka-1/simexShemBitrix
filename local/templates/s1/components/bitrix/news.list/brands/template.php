...
<section class="section brands anim-fade-in-up">
    <div class="container">
        <div class="heading anim-fade-in-left">
            <h1 class="h2">Бренды нашей компании</h1>
            <div class="hand_icon">
        ...
        <div class="brands__cards anim-stagger">
            <a href="/brand" class="brands__card anim-scale-in">
                <div class="brands__card_logo">
                    <img src="/assets/img/brands/exenoil.svg" alt="Exenoil логотип" class="brands__item_img-gray">
                    <!-- <img src="/assets/img/brands/exenoil-color.svg" alt="Exenoil логотип color"
                        class="brands__item_img-color" aria-hidden="true"> -->
                </div>
                <div class="brands__card_img">
                    <!-- <img src="/assets/img/barrel-hide.png" alt="Exenoil бочка" class="brands__item_img-gray"> -->
                    <img src="/assets/img/barrel-si.png" alt="Exenoil бочка color" class="brands__item_img-color"
                        aria-hidden="true">
                </div>
                <div class="brands__card_btn">
                    <div class="btn btn-round-lg accent">
            ...
            <a href="/brand" class="brands__card anim-scale-in">
                <div class="brands__card_logo">
                    <img src="/assets/img/brands/simy.svg" alt="Si my логотип" class="brands__item_img-gray">
                    <!-- <img src="/assets/img/brands/simy-color.svg" alt="Simy логотип color" class="brands__item_img-color"
                        aria-hidden="true"> -->
                </div>
                <div class="brands__card_img">
                    <!-- <img src="/assets/img/barrel-hide.png" alt="Exenoil бочка" class="brands__item_img-gray"> -->
            ...
            <a href="/brand" class="brands__card anim-scale-in">
                <div class="brands__card_logo">
                    <img src="/assets/img/brands/si.svg" alt="Si логотип" class="brands__item_img-gray">
                <!-- <img src="/assets/img/brands/si-color.svg" alt="Si логотип color" class="brands__item_img-color"
                    aria-hidden="true"> -->
                </div>
                <div class="brands__card_img">
                    <!-- <img src="/assets/img/barrel-hide.png" alt="Exenoil бочка" class="brands__item_img-gray"> -->
            ...
            <a href="/brand" class="brands__card anim-scale-in">
                <div class="brands__card_logo">
                    <img src="/assets/img/brands/vipro.svg" alt="Випро логотип" class="brands__item_img-gray">
                <!-- <img src="/assets/img/brands/vipro-color.svg" alt="Випро логотип color" class="brands__item_img-color"
                    aria-hidden="true"> -->
                </div>
                <div class="brands__card_img">
                    <!-- <img src="/assets/img/barrel-hide.png" alt="Exenoil бочка" class="brands__item_img-gray"> -->
            ...
            <a href="/brand" class="brands__card anim-scale-in">
                <div class="brands__card_logo">
                    <img src="/assets/img/brands/sintolit.svg" alt="Sintolit логотип" class="brands__item_img-gray">
                <!-- <img src="/assets/img/brands/sintolit-color.svg" alt="Sintolit логотип color"
                    class="brands__item_img-color" aria-hidden="true"> -->
                </div>
                <div class="brands__card_img">
                    <!-- <img src="/assets/img/barrel-hide.png" alt="Exenoil бочка" class="brands__item_img-gray"> -->
