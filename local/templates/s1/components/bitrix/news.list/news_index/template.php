...
?>
<section class="section section-dark section-round-top section-round-bottom news anim-fade-in-up">
    <div class="container">
        ...
        <div class="news__content">
            ...
            <div class="news__more_link">
                <a href="<?=$arResult['LIST_PAGE_URL'] ?>" class="btn btn-light ">Смотреть все</a>
            </div>
        </div>
    </div>
</section>
