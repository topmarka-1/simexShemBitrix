    ...
    <div class="container">
        ...
        <div class="brands__cards anim-stagger">
			<?foreach($arResult["ITEMS"] as $arItem):?>
				...
				?>
				<a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="brands__card anim-scale-in" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
					<div class="brands__card_logo">
						<img src="<?=\CFile::GetPath($arItem['PROPERTIES']['LOGO_COLOR']['VALUE']); ?>" alt="<?=$arItem['NAME']?> логотип" class="brands__item_img-gray">
					</div>
					<div class="brands__card_img">
						<img src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>"
								...
								title="<?=$arItem["PREVIEW_PICTURE"]["TITLE"]?>" class="brands__item_img-color"
							aria-hidden="true">
					</div>
        ...
        <div class="history__list">
            <div class="history__item">
                <div class="history__item_image">
                    <img src="<?=\CFile::GetPath($arResult['PICTURE']); ?>" alt="" width="1040" height="586">
                </div>
