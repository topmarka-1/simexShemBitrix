...
<div class="request__content_form">
	<form action="/" class="request__form">
		<div class="form__content">
			<div class="request__form_title">Заявка на сотрудничество</div>
			<div class="request__form_fields">
				<div class="form__field">
					<div class="form__field_title">Как вас зовут?</div>
					<label class="label-text">
						<input type="text" name="name" placeholder="Ваше имя">
					</label>
				</div>
				<div class="form__field">
					<div class="form__field_title">Ваш номер телефона:</div>
					<label class="label-text">
						<input type="tel" name="name" placeholder="+7 (___) ___-__-__">
					</label>
				</div>
				<div class="form__field">
					<div class="form__field_title">Ваша электронная почта:</div>
					<label class="label-text">
						<input type="email" name="name" placeholder="info@simex-chem.ru">
					</label>
				</div>
				<div class="form__field">
				...
				<div class="form__field">
					...
					<div class="agree">
						<label class="label-checkbox">
							...
							<input type="checkbox" name="policy" value="да">
							<span class="checkbox"></span>
							<span class="text">Нажимая кнопку «Отправить» вы соглашаетесь
								с нашей <a href="#">политикой конфиденциальности
									данных</a></span>
						</label>
					</div>
				</div>
