						...
						<div id="bx-soa-order" class="row bx-<?= $arParams['TEMPLATE_THEME'] ?>" style="opacity: 0">
							...
							<div class="col-sm-9 bx-soa">
								...
								<div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active">
									...
									<div class="bx-soa-section-content get-catalog__form_container"></div>
								</div>
								...
								<div id="bx-soa-orderSave">
									...
									<a href="javascript:void(0)" style="margin: 10px 0" class="btn btn-primary btn-lg hidden-xs" data-save-button="true">
										<?= $arParams['MESS_ORDER'] ?>
									</a>
								</div>
