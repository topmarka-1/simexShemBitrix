					...
					<form action="<?= POST_FORM_ACTION_URI ?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
						...
						<div id="bx-soa-order" class="bx-<?= $arParams['TEMPLATE_THEME'] ?>" style="opacity: 0">
							...
							<div class="bx-soa">
								...
								<!--	AUTH BLOCK	-->
								<div id="bx-soa-auth" class="bx-soa-section bx-soa-auth personal__item" style="display:none">
								...
								<div id="bx-soa-orderSave">
									...
									<a href="javascript:void(0)" class="btn btn-primary" data-save-button="true">
										<?= $arParams['MESS_ORDER'] ?>
									</a>
								</div>
