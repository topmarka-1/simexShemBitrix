...
class main extends CModule
{
	...
	function InstallDB()
	{
		...
		RegisterModuleDependences("humanresources", "OnMemberUpdated", "main", "\\Bitrix\\Main\\Access\\Auth\\HrAccessEventHandler", "onMemberUpdated");
		RegisterModuleDependences("humanresources", "OnMemberDeleted", "main", "\\Bitrix\\Main\\Access\\Auth\\HrAccessEventHandler", "onMemberDeleted");
		RegisterModuleDependences("humanresources", "OnMemberAdded", "main", "\\Bitrix\\Main\\Access\\Auth\\HrAccessEventHandler", "onMemberAdded");
