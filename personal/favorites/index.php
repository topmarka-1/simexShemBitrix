            ...
            <div class="personal__content">
                <aside class="personal__aside">
                    <nav class="personal__aside_nav anim-stagger" data-ajax-nav>
                        <ul>
                            <li><a class="btn btn-quad-md btn-white" href="/personal/"><svg width="24" height="24" viewBox="0 0 16 16" fill="none"
                            ...
                            <li><a class="btn btn-quad-md btn-white" href="/personal/orders/"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li><a class="btn btn-quad-md btn-white active" href="/personal/favorites/"><svg width="26" height="24" viewBox="0 0 17 16" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <li><a class="btn btn-quad-md btn-white" href="/personal/cart/"><svg width="25" height="24" viewBox="0 0 17 16" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <li><a class="btn btn-quad-md btn-white" href="/personal/private/"><svg width="27" height="26" viewBox="0 0 27 26" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                ...
                ?>
                <?php $APPLICATION->IncludeComponent("custom:favorites.section", "", array()); ?>
                <?php $APPLICATION->IncludeComponent("custom:favorites.elements", "", array()); ?>
                <?php
                if ($isAjax) {
                    // nothing to close
                } else {
