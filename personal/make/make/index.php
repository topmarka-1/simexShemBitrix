...
?><? $APPLICATION->IncludeComponent(
		...
		array(
			...
			"ADDITIONAL_PICT_PROP_14" => "-",	// Дополнительная картинка [Каталог товаров 4F802CD5]
			"ADDITIONAL_PICT_PROP_6" => "-",	// Дополнительная картинка [Товары]
			...
			"PRODUCT_COLUMNS_VISIBLE" => array(	// Выбранные колонки таблицы списка товаров
				0 => "PREVIEW_PICTURE",
				1 => "PROPS",
				2 => "PROPERTY_OBEM_VES_NETTO",
				3 => "PROPERTY_CML2_ARTICLE",
				4 => "PROPERTY_KLASS_VYAZKOSTI_SAE",
				5 => "PROPERTY_EDINITSA_IZMERENIYA_OBEMA_VESA_NETTO",
			),
